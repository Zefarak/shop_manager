...
from .views import HomepageView, NewProductsView, product_view, AboutUsView, CartView, CheckoutView, order_detail, delete_session_view
...
urlpatterns = [
    ...
    path('delete-session/', delete_session_view)
