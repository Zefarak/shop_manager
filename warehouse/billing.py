...
class BillCategory(models.Model):
    ...
    balance = models.DecimalField(default=0, max_digits=50, decimal_places=2, verbose_name='Υπόλοιπο')
    ...
    def get_delete_url(self):
        return reverse('warehouse:bill_invoice_delete_view', kwargs={'pk': self.id})
